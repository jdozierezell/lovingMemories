                    ...
                    <div className="memory-holder" id="memoryHolder" ref={sliderRef}>
                        {(isMobile == false) ? (
                            <div className="memory-journey" id="memoryJourney" ref={panelsContainer}>
                                <section id="panel1" className={`memory-panel intro h-full w-full flex flex-col md:flex-row items-center pattern-bg ${bgTheme} `} ref={(e) => createPanelsRefs(e, 0)}>
                                    ...
                                    <div className={'split-50 h-full w-full'} style={{backgroundImage: 'url(' + imageUrl + ')', backgroundColor: '#ffffff5e', backdropFilter: 'hue-rotate(15deg)', backgroundSize: 'cover', backgroundPosition: 'center'}}></div>

                                </section>
                                {(description !== "") ? (
                                    <section id="panel2" className="memory-panel description h-full w-full flex flex-col md:flex-row items-center" ref={(e) => createPanelsRefs(e, 1)}>
                                        {(description2 !== '') ? (
                                ...
                                {( photos.length >= 2 ) ? (
                                    <section id="panel3" className={`memory-panel image-holder h-full w-full vertical flex flex-col md:flex-row items-center scrollable `} ref={(e) => createPanelsRefs(e, 2)}>
                                ...
                                {(favorites.length <= 0) ? (
                                    ...
                                    <section id="panel4" className={`memory-panel h-full w-full flex flex-col md:flex-row items-center pattern-bg ${bgTheme} `} style={{touchAction: 'pan-y'}} ref={(e) => createPanelsRefs(e, 3)}>
                                ...
                                <section id="panel5" className={`memory-panel outro h-full w-full flex flex-col md:flex-row items-center pattern-bg ${bgTheme} `} ref={(e) => createPanelsRefs(e, 4)}>
                                    <div className={'split-60'}>
                                        <div
