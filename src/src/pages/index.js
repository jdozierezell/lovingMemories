                    ...
                    <div id='grid' className='h-screen gap-0 w-screen'>
                        ...
                        <div id='areaA' className='flex items-center justify-center'>
                            ...
                            <div className='p-6 pt-10'>
                                    ...
                                    <h1 className="font-bold text-center text-4xl md:text-5xl lg:text-6xl lg:text-left">In memory
                                    of <br/>my <span> <TextLoop springConfig={{stiffness: 180, damping: 8}}
                                                                mask={true} interval={6000}
                                                                children={['friend', 'mother', 'brother', 'son', 'sister', 'cousin', 'father', 'aunt', 'husband', 'teacher', 'uncle', 'daughter', 'colleague', 'wife', 'student']}/></span>
                                </h1>

                                <p className="my-5 md:my-10 text-center lg:text-left max-w-lg">The digital quilt is where
                                    suicide loss surviors can honor and share stories about their loved
                                    ones.</p>

                                <div className="grid grid-cols-1 md:grid-cols-2 gap-1">
                                    <div className="mx-auto">

                                        <button onClick={() => beginAgain()}
                                    ...
                                    <div className="mx-auto">
                                        <Link to="/search">
                                            <button
                                                className="flex flex-wrap items-center justify-between px-8 py-3 mt-4 text-xs md:text-sm leading-none text-blue-500 border-2 border-blue-500 rounded-full hover:border-transparent hover:text-white hover:bg-blue-900 lg:mt-0"
                                            >
