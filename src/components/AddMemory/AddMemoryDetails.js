...
const AddMemoryDetails = props => {
    ...
    const renderButton = () => {
        return (
            ...
            <div
                className="memory-fields-footer absolute bg-white w-full bottom-0 left-0 text-center p-2 lg:p-8 border-t-2"> {/* md:p-8 */}
                <button
                    className="flex flex-wrap items-center mx-auto justify-between mt-2 mb-2 leading-none bg-transparent text-gray-600 border-2 border-gray-600 rounded-full hover:border-blue-600 hover:text-white hover:bg-blue-600 lg:mt-0 disabled:opacity-50">
          <span>
            ...
            <Spin spinning={loading} indicator={loadingIcon}>
                ...
                <section className="grid grid-cols-1 lg:grid-cols-2 gap-4">
                            ...
                            <div className="px-5 md:px-14 lg:px-20">
                                <div className="mt-10 lg:mt-20">
                                    ...
                                    <div className="w-full mb-8">
                                        ...
                                        <div
                                            className="border-b border-0 appearance-none w-full py-2 text-gray-700 leading-tight outline-none text-2xl">
                                            <AutoComplete
                                                id="loving"
                                                name="loving"
                                        ...
                                        {isFilled == true ? (
                                            <p className="text-pink-500 text-sm mt-2">* A relation of your loved one is Required</p>
                                        ) : (
                                            <span></span>
                                        )}
                                    </div>
                    ...
                    <div className="order-1 lg:order-2 pt-0 md:pt-20 ">
                        <SideComponent
                            text1="The Digital Memory Quilt is an online space where you can honor and share stories of your loved ones, Lorem Ipsum is simply dummy text of the printing and typesetting industry."/>
                    </div>
