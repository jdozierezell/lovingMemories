...
function Main({ siteTitle }) {
  ...
  return (
    <nav className="relative lg:absolute w-full flex md:flex-wrap items-center justify-between p-4  bg-transparent z-10">
      <div className="flex items-center">
        <span>
          <img  src="../../svg/logo-afsp.svg" placeholder="white" alt="logo" />
        </span>
      </div>
  ...
  <Link to="/app/login">
          <button
            className="btn-signin inline-block px-0 sm:px-8 py-2 w-20 md:w-auto text-xs md:text-lg leading-none bg-white text-blue-500 border border-blue-500 rounded-full hover:border-transparent hover:text-white hover:bg-blue-500 lg:mt-0"
          >
            Sign In
          </button>
          </Link>
